                    ...
                    <div className="col-12 col-lg-4 col-md-8 md-mb-50px">
                        <div className="position-sticky top-120px"
                            ...
                            <a href="/contact" className="btn btn-large btn-dark-gray btn-box-shadow">Let&apos;s talk
                                now<i className="fa-regular fa-envelope"></i></a>
                        </div>
                    </div>
...
const data = [
    ...
    {
        text: "Client satisfaction with their new website.",
        value: 100,
        unit: "%",
    },
];
        ...
        <div className="row g-0 counter-style-04"
            ...
            {data.map((item, index) => (
                ...
                >
                    ...
                    <h2 className="alt-font vertical-counter d-inline-flex text-dark-gray fw-700 ls-minus-2px mt-20 sm-mb-0"
                        data-text={item.unit} data-to={item.value}>
                        <sup className="top-0">
