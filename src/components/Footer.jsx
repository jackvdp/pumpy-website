...
export default function Footer({sticky}) {
    return (
        <footer className={`pb-0 bg-base-color bg-sliding-line ${sticky && "footer-sticky"}`} style={{zIndex: "-1"}}>
            <div className="container">
                <div className="row">
                    <div
                        ...
                        <div className="elements-social social-text-style-01 mt-auto">
                            <ul className="small-icon dark fw-600">
                                <li><a className="twitter" href="https://x.com/JackVanderpump" target="_blank">Tw.</a>
                                </li>
                                <li><a className="linkedin"
                                       href="https://www.linkedin.com/in/jack-vanderpump-3421a3105/"
                                       target="_blank">Li.</a></li>
                                <li><a className="github" href="https://www.github.com/jackvdp" target="_blank">Gi.</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div
                        className="col-12 col-xl-3 col-lg-4 col-md-6 last-paragraph-no-margin order-lg-2 order-md-3 sm-mb-20px">
                        <span
                            className="fs-14 fw-600 d-block text-dark-gray text-dark-gray text-uppercase">Quick Links</span>
                        <a href="/">About</a><br/>
                    ...
                    <div className="col-12 col-xl-3 col-lg-4 col-md-6 last-paragraph-no-margin order-md-4 sm-mb-30px">
                        <span
                            className="fs-14 fw-600 d-block text-dark-gray text-dark-gray text-uppercase">Contact</span>
                        <a href="mailto:jack@vanderpump.tech"
                           className="text-dark-gray text-decoration-line-bottom fw-600 mb-50px sm-mb-30px d-inline-block">jack@vanderpump.tech</a>
                    </div>
                    <ContactForm/>
                </div>
                <div className="row justify-content-center align-items-center pt-5 sm-pt-35px">
                    ...
                    <div
                        className="col-lg-5 pt-15px pb-15px md-pt-0 fs-15 order-2 order-lg-1 text-center text-lg-start last-paragraph-no-margin">
                        <p>© {new Date().getFullYear().toString()} Vanderpump Tech</p></div>
                    <div
                        className="col-lg-7 pt-15px pb-15px md-pb-5px fs-15 order-1 order-lg-2 text-center text-lg-end"></div>
                </div>
            </div>
        </footer>
    )
      ...
      <span className="fs-14 fw-600 d-block text-dark-gray mb-15px text-dark-gray text-uppercase">
        Get in touch
            ...
            <div className="d-inline-block w-100 newsletter-style-02 position-relative mb-10px">
                {state.succeeded ? (
                    <div
                        className="border-radius-4px pt-15px pb-15px ps-15px pe-15px w-100 text-center bg-success-subtle">
